...
use crate::{
    ...
    models::{CreateServerDto, MemberDto, Server, ServerDto, ServerMember, UpdateServerDto},
    state::AppState,
};
...
/// Fetch server, returning 404 if not found.
...
/// Return 404 if the user is not a member of the server.
